package com.example.EcoHack.config.security;

import com.example.EcoHack.config.configProperties.CorsConfigProperties;
import com.example.EcoHack.config.security.filters.CustomAuthenticationFilter;
import com.example.EcoHack.config.security.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager, CustomAuthorizationFilter customAuthorizationFilter, AppUserService appUserService, MultiAuthIdentityProvider multiAuthIdentityProvider) throws Exception {
        ...
        customAuthorizationFilter.addPublicUnprotectedEndpointsAntMatcher("/resources/**");
