...
import com.example.EcoHack.exceptions.api.unauthorized.InvalidTokenException;
import com.example.EcoHack.exceptions.api.unauthorized.InvalidTokenTypeException;
import com.example.EcoHack.exceptions.api.unauthorized.InvalidTokenUserException;
...
import com.example.EcoHack.security.DTO.TokenPair;
...
public class JwtUtils implements Serializable {
    ...
    public TokenDetails getTokenDetailsFromAuthorizationHeader(String authorizationHeader, AppUserService appUserService){
        ...
        try {
            ...
            throw new com.example.EcoHack.exceptions.api.unauthorized.TokenExpiredException(exception);
