package com.example.EcoHack.util;
...
public class Utilities {
    ...
    public static final String ROOT_WORKING_DIR = getRootDirFromWorkingDir();
    ...
    public static String getRootDirFromWorkingDir() {
        return "./";
    }
    ...
    public static Path getResourcesPath() {
        return Paths.get(getResourcesPath_());
    }
